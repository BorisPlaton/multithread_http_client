from exceptions.client_exceptions import URLNotInProcess, ValidationException
...
class WorkersManager:
    ...
    def create_new_tasks_for_workers(self, url_content_data: URLResourceData):
        ...
        workers.
        """
        self.url_statuses.add_url_to_in_process(url_content_data.url, url_content_data.summary_length)
